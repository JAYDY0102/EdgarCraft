...
abstract class Recipe {
    companion object {
        ...
        val endermanSwordItemStack = ItemStack(Material.NETHERITE_SWORD).apply {
            ...
            itemMeta = itemMeta.apply { setCustomModelData(3) }
            itemMeta = itemMeta.apply { removeAttributeModifier(Attribute.ATTACK_DAMAGE) }
            itemMeta = itemMeta.apply { addAttributeModifier(Attribute.ATTACK_DAMAGE, AttributeModifier(NamespacedKey("Enderman Sword","Enderman Sword"), 8.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND))}
        }
        val witherLongSwordItemStack = ItemStack(Material.NETHERITE_SWORD).apply {
            ...
            itemMeta = itemMeta.apply { addAttributeModifier(Attribute.ENTITY_INTERACTION_RANGE, AttributeModifier(NamespacedKey("Wither Sword","Wither Sword"), 1.5, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND)) }
            itemMeta = itemMeta.apply { removeAttributeModifier(Attribute.ATTACK_DAMAGE) }
            itemMeta = itemMeta.apply { addAttributeModifier(Attribute.ATTACK_DAMAGE, AttributeModifier(NamespacedKey("Wither Sword","Wither Sword"), 6.5, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND))}
        }
        ...
        val elderGuardiansThornItemStack = ItemStack(Material.NETHERITE_SWORD).apply {
            ...
            itemMeta = itemMeta.apply { setCustomModelData(5) }
            itemMeta = itemMeta.apply { removeAttributeModifier(Attribute.ATTACK_DAMAGE) }
            itemMeta = itemMeta.apply { addAttributeModifier(Attribute.ATTACK_DAMAGE, AttributeModifier(NamespacedKey("Elder Guardian Thorn","Elder Guardian Thorn"), 11.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND))}
        }
        val shulkSwordItemStack = ItemStack(Material.NETHERITE_SWORD).apply {
            ...
            itemMeta = itemMeta.apply { setCustomModelData(6) }
            itemMeta = itemMeta.apply { removeAttributeModifier(Attribute.ATTACK_DAMAGE) }
            itemMeta = itemMeta.apply { addAttributeModifier(Attribute.ATTACK_DAMAGE, AttributeModifier(NamespacedKey("Sculk Sword","Sculk Sword"), 8.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND))}
        }
        val roseSwordItemStack = ItemStack(Material.NETHERITE_SWORD).apply {
            ...
            itemMeta = itemMeta.apply { setCustomModelData(7) }
            itemMeta = itemMeta.apply { removeAttributeModifier(Attribute.ATTACK_DAMAGE) }
            itemMeta = itemMeta.apply { addAttributeModifier(Attribute.ATTACK_DAMAGE, AttributeModifier(NamespacedKey("Rose Sword","Rose Sword"), 7.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND))}
        }
        ...
        val piglinsArmorItemStack: ItemStack = ItemStack(Material.LEATHER_CHESTPLATE).apply {
            itemMeta = (itemMeta as LeatherArmorMeta).apply {
                ...
                isFireResistant = true
                removeAttributeModifier(EquipmentSlot.CHEST)
                addAttributeModifier(Attribute.ARMOR, AttributeModifier(NamespacedKey("Piglin Chestplate","Piglin Chestplate"),7.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.CHEST))
                addAttributeModifier(Attribute.ARMOR_TOUGHNESS, AttributeModifier(NamespacedKey("Piglin Chestplate","Piglin Chestplate"),4.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.CHEST))
                addAttributeModifier(Attribute.KNOCKBACK_RESISTANCE, AttributeModifier(NamespacedKey("Piglin Chestplate","Piglin Chestplate"),0.2, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.CHEST))
        ...
        val flyingChickenPantsItemStack: ItemStack = ItemStack(Material.LEATHER_LEGGINGS).apply {
            itemMeta = (itemMeta as LeatherArmorMeta).apply {
                ...
                addAttributeModifier(Attribute.ARMOR, AttributeModifier(NamespacedKey("Flying Chicken Pants","Flying Chicken Pants"),5.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.LEGS))
                addAttributeModifier(Attribute.GRAVITY,AttributeModifier(NamespacedKey("Flying Chicken Pants","Flying Chicken Pants"),0.05, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.LEGS))
                setColor(Color.fromRGB(255, 0, 0))
            }
            itemMeta = (itemMeta as Damageable).apply {
                setMaxDamage(272)
        ...
        val anvilPantsItemStack: ItemStack = ItemStack(Material.LEATHER_LEGGINGS).apply {
            itemMeta = (itemMeta as LeatherArmorMeta).apply {
                ...
                setCustomModelData(2)
                removeAttributeModifier(EquipmentSlot.LEGS)
                addAttributeModifier(Attribute.ARMOR, AttributeModifier(NamespacedKey("Hardened Steel Greaves","Hardened Steel Greaves"),8.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.LEGS))
                addAttributeModifier(Attribute.ARMOR_TOUGHNESS, AttributeModifier(NamespacedKey("Hardened Steel Greaves","Hardened Steel Greaves"),4.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.LEGS))
                addAttributeModifier(Attribute.KNOCKBACK_RESISTANCE, AttributeModifier(NamespacedKey("Hardened Steel Greaves","Hardened Steel Greaves"),0.2, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.LEGS))
                setColor(Color.fromRGB(0, 0, 255))
            }
            itemMeta = (itemMeta as Damageable).apply {
                setMaxDamage(784)
        ...
        val oceansBootsItemStack: ItemStack = ItemStack(Material.LEATHER_BOOTS).apply {
            itemMeta = (itemMeta as LeatherArmorMeta).apply {
                ...
                addAttributeModifier(Attribute.ARMOR, AttributeModifier(NamespacedKey("Ocean Pact","Ocean Pact"),4.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET))
                addAttributeModifier(Attribute.SAFE_FALL_DISTANCE, AttributeModifier(NamespacedKey("Ocean Pact","Ocean Pact"),512.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET))
